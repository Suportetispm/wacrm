...
export async function POST(request: Request) {
  try {
    // Disparar um broadcast é uma escrita — a RLS de `broadcasts` já
    // exige `agent` (017_account_sharing.sql), mas esta rota nunca
    // passa pela RLS dessa tabela (chama o provider do WhatsApp
    // diretamente), então sem esta checagem qualquer membro
    // autenticado da conta — inclusive um viewer — conseguia disparar
    // um envio.
